...
| [D-0003](D-0003-no-unified-agent-capability-adapter.md) | Sem interface única p/ o de/para das particularidades de cada coding agent (mode/model/effort); o dialeto de cada adapter vaza pro yml | `src/acp/session.ts` · `src/steps/agent.ts` · `src/config/schema.ts` | média | resolvido em C-0016 (ADR-0008) |
